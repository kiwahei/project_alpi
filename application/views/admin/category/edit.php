...
<div id="main">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?= base_url()?>admin/category/update/<?= $category->id ?>"  enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="<?= base_url("uploads/category/").$category->image ?>" alt="" class="d-block">
