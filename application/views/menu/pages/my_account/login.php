...
<!-- Mirrored from www.annimexweb.com/items/hema/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:46:24 GMT -->
<head>
                            ...
                            <div class="col-12 col-md-8 col-lg-6">
                                <div class="card shadow-sm border-0">
                                    <div class="card-body p-4">
                                        <!-- Form Open -->
                                        <?php echo form_open('pages/login', ['class' => 'customer-form']); ?>
                                        ...
                                        <div class="text-center mt-4">
                                            <p class="text-muted mb-0">
                                                ...
                                                <a href="<?php echo site_url('pages/register'); ?>" class="btn-link">Register Now</a>
                                            </p>
                                        </div>
