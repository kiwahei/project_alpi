...
<!-- Mirrored from www.annimexweb.com/items/hema/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:46:08 GMT -->
<head>
        ...
        <!-- Title Of Site -->
        <title>My Account - Project PWE</title>
                ...
                <div class="container">        
                    <div class="row">
                        ...
                        <div class="logo col-5 col-sm-3 col-md-3 col-lg-2 align-self-center">
                            <a class="logoImg"><img src="assets/images/logo.png" alt="Hema Multipurpose Html Template" title="Hema Multipurpose Html Template" width="149" height="39" /></a>
                        </div>
                        <!--End Logo-->
                        <!--Menu-->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                                ...
                                <!--Breadcrumbs-->
                                <div class="breadcrumbs"><a href="<?php echo site_url('home'); ?>" title="Back to the home page">Home</a><span class="title"><i class="icon anm anm-angle-right-l"></i></span><span class="main-title fw-bold"></i>My Account</span></div>
                                <!--End Breadcrumbs-->
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="dashboard-sidebar bg-block">
                                <div class="profile-top text-center mb-4 px-3">
                                    ...
                                    <div class="profile-detail">
                                        <h3 class="mb-1">Alfiansyah Aresta</h3>
                                        <p class="text-muted">alfiansyaharesta1412@gmail.com</p>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade h-100 show active" id="info">
                                    <div class="account-info h-100">
                                        <div class="welcome-msg mb-4">
                                            <h2>Hai, <span class="text-primary">Alfiansyah Aresta</span></h2>
                                            <p>Have fun to shop.</p>
                                        </div>
                                        ...
                                        <!-- <div class="row g-3 row-cols-lg-3 row-cols-md-3 row-cols-sm-3 row-cols-1 mb-4">
                                            <div class="counter-box">
                                                <div class="bg-block d-flex-center flex-nowrap">
                                                    ...
                                                    <div class="content">
                                                        <h3 class="fs-5 mb-1 text-primary">0</h3>
                                                        <p>Total Order</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                                <div class="box-info mb-4">
                                                    ...
                                                    <div class="box-content mt-3">
                                                        <h5>Alfiansyah Aresta</h5>
                                                        <p class="mb-2">alfiansyaharesta1412@gmail.com</p>
                                            ...
                                            <div class="box-info mb-4">
                                                ...
                                                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                                    <div class="box-content mt-3">
                                                        ...
                                                        <address class="mb-2">Jl. Ungaran Ujung No.14, <br/>Kel. Pasar Manggis, Kec. Setia Budi, <br/>Jakarta Selatan | 12970.</address>
...
<!-- Mirrored from www.annimexweb.com/items/hema/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:46:24 GMT -->
</html>