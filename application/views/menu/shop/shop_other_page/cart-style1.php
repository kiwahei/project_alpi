...
<!-- Mirrored from www.annimexweb.com/items/hema/cart-style1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:43:48 GMT -->
<head>
                            ...
                            <nav class="navigation" id="AccessibleNav">
                                <ul id="siteNav" class="site-nav medium center">
                                    <li class="lvl1 parent dropdown"><a href="#">Home <i class="icon anm anm-angle-down-l"></i></a>
                                        <ul class="dropdown">
                                            <li><a href="<?php echo site_url('home'); ?>">Home 01 - Fashion</a></li>
                                            <li><a href="<?php echo site_url('home/footwear'); ?>">Home 02 - Footwear</a></li>
                                            <li><a href="<?php echo site_url('home/bags'); ?>">Home 03 - Bags</a></li>
                                            <li><a href="<?php echo site_url('home/electronic'); ?>">Home 04 - Electronic</a></li>
                                            <li><a href="<?php echo site_url('home/tools_parts'); ?>">Home 05 - Tools &amp; Parts</a></li>
                                            <li><a href="<?php echo site_url('home/jewelry'); ?>">Home 06 - Jewelry</a></li>
                                            <li><a href="<?php echo site_url('home/organic_food'); ?>">Home 07 - Organic Food</a></li>
                                            <li><a href="<?php echo site_url('home/cosmetics'); ?>">Home 08 - Cosmetics</a></li>
                                            <li><a href="<?php echo site_url('home/furniture'); ?>">Home 09 - Furniture</a></li>
                                            <li><a href="<?php echo site_url('home/sunglasses'); ?>">Home 10 - Sunglasses</a></li>
                                            <li><a href="<?php echo site_url('home/medical'); ?>">Home 11 - Medical</a></li>
                                            <li><a href="<?php echo site_url('home/christmas'); ?>">Home 12 - Christmas</a></li>
                                        </ul>
                                    </li>
                                        ...
                                        <div class="megamenu style1">
                                            <ul class="row grid--uniform mmWrapper">
                                                <li class="lvl-1 col-md-3 col-lg-3 w-22"><a href="#;" class="site-nav lvl-1 menu-title">Collection Page</a>
                                                    <ul class="subLinks">
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/collection_style1'); ?>" class="site-nav lvl-2">Collection style1</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/collection_style2'); ?>" class="site-nav lvl-2">Collection style2</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/collection_style3'); ?>" class="site-nav lvl-2">Collection style3</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/collection_style4'); ?>" class="site-nav lvl-2">Collection style4</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/sub_collection_style1'); ?>" class="site-nav lvl-2">Sub Collection style1</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/sub_collection_style2'); ?>" class="site-nav lvl-2">Sub Collection style2</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/collection_empty'); ?>" class="site-nav lvl-2">Collection Empty</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_search_results'); ?>" class="site-nav lvl-2">Shop Search Results</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_swatches_style'); ?>" class="site-nav lvl-2">Shop Swatches Style</a></li>
                                                    </ul>
                                                </li>
                                                <li class="lvl-1 col-md-3 col-lg-3 w-22"><a href="#;" class="site-nav lvl-1 menu-title">Shop Page</a>
                                                    <ul class="subLinks">
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_grid_view'); ?>" class="site-nav lvl-2">Shop Grid View</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_list_view'); ?>" class="site-nav lvl-2">Shop List View</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_left_sidebar'); ?>" class="site-nav lvl-2">Shop Left Sidebar</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_right_sidebar'); ?>" class="site-nav lvl-2">Shop Right Sidebar</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_top_filter'); ?>" class="site-nav lvl-2">Shop Top Filter</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_masonry_grid'); ?>" class="site-nav lvl-2">Shop Masonry Grid</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_with_category'); ?>" class="site-nav lvl-2">Shop With Category</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_grid_view'); ?>" class="site-nav lvl-2">Classic Pagination</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/shop_right_sidebar'); ?>" class="site-nav lvl-2">Infinite Scrolling</a></li>
                                                    </ul>
                                                </li>
                                                <li class="lvl-1 col-md-3 col-lg-3 w-22"><a href="#;" class="site-nav lvl-1 menu-title">Shop Other Page</a>
                                                    <ul class="subLinks">
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/wishlist_style1'); ?>" class="site-nav lvl-2">Wishlist Style1</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/wishlist_style2'); ?>" class="site-nav lvl-2">Wishlist Style2</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/compare_style1'); ?>" class="site-nav lvl-2">Compare Style1</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/compare_style2'); ?>" class="site-nav lvl-2">Compare Style2</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/cart_style1'); ?>" class="site-nav lvl-2">Cart Style1</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/cart_style2'); ?>" class="site-nav lvl-2">Cart Style2</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/checkout_style1'); ?>" class="site-nav lvl-2">Checkout Style1</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/checkout_style2'); ?>" class="site-nav lvl-2">Checkout Style2</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('shop/order_success'); ?>" class="site-nav lvl-2">Order Success</a></li>
                                                    </ul>
                                                </li>
                                        ...
                                        <div class="megamenu style2">
                                            <ul class="row mmWrapper">
                                                <li class="lvl-1 col-md-3 col-lg-3"><a href="#;" class="site-nav lvl-1 menu-title">Product Page</a>
                                                    <ul class="subLinks">
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout1'); ?>" class="site-nav lvl-2">Product Layout1</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout2'); ?>" class="site-nav lvl-2">Product Layout2</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout3'); ?>" class="site-nav lvl-2">Product Layout3</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout4'); ?>" class="site-nav lvl-2">Product Layout4</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout5'); ?>" class="site-nav lvl-2">Product Layout5</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout6'); ?>" class="site-nav lvl-2">Product Layout6</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout7'); ?>" class="site-nav lvl-2">Product Layout7</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_3d_ar_models'); ?>" class="site-nav lvl-2">Product 3D, AR models</a></li>
                                                    </ul>
                                                </li>
                                                <li class="lvl-1 col-md-3 col-lg-3"><a href="#;" class="site-nav lvl-1 menu-title">Product Page Types</a>
                                                    <ul class="subLinks">
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_standard'); ?>" class="site-nav lvl-2">Standard Product</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_variable'); ?>" class="site-nav lvl-2">Variable Product</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_grouped'); ?>" class="site-nav lvl-2">Grouped Product</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout4'); ?>" class="site-nav lvl-2">Product Back in stock</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout6'); ?>" class="site-nav lvl-2">Product Accordion</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout7'); ?>" class="site-nav lvl-2">Product Tabs Left</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_layout6'); ?>" class="site-nav lvl-2">Product Bundle</a></li>
                                                        <li class="lvl-2"><a href="<?php echo site_url('product/product_360_view'); ?>" class="site-nav lvl-2">Product 360 View</a></li>
                                                    </ul>
                                                </li>
                                    ...
                                    <li class="lvl1 parent dropdown"><a href="#">Pages <i class="icon anm anm-angle-down-l"></i></a>
                                        <ul class="dropdown">
                                            <li><a href="aboutus-style1.html" class="site-nav">About Us <i class="icon anm anm-angle-right-l"></i></a>
                                                <ul class="dropdown">
                                                    <li><a href="<?php echo site_url('pages/aboutus_style1'); ?>" class="site-nav">About Us Style1</a></li>
                                                    <li><a href="<?php echo site_url('pages/aboutus_style2'); ?>" class="site-nav">About Us Style2</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li><a href="my-account.html" class="site-nav">My Account <i class="icon anm anm-angle-right-l"></i></a>
                                                <ul class="dropdown">
                                                    <li><a href="<?php echo site_url('pages/my_account'); ?>" class="site-nav">My Account</a></li>
                                                    <li><a href="<?php echo site_url('pages/login'); ?>" class="site-nav">Login</a></li>
                                                    <li><a href="register.html" class="site-nav">Register</a></li>
                                                    <li><a href="<?php echo site_url('pages/forgot_password'); ?>" class="site-nav">Forgot Password</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="lookbook-grid.html" class="site-nav">Lookbook <i class="icon anm anm-angle-right-l"></i></a>
                                                <ul class="dropdown">
                                                    <li><a href="<?php echo site_url('pages/lookbook_grid'); ?>" class="site-nav">Lookbook Grid</a></li>
                                                    <li><a href="<?php echo site_url('pages/lookbook_masonry'); ?>" class="site-nav">Lookbook Masonry</a></li>
                                                    <li><a href="<?php echo site_url('pages/lookbook_shop'); ?>" class="site-nav">Lookbook Shop</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="<?php echo site_url('pages/portfolio_page'); ?>" class="site-nav">Portfolio Page</a></li>
                                            <li><a href="<?php echo site_url('pages/faqs_page'); ?>" class="site-nav">FAQs Page</a></li>
                                            <li><a href="<?php echo site_url('pages/brands_page'); ?>" class="site-nav">Brands Page</a></li>
                                            <li><a href="<?php echo site_url('pages/cms_page'); ?>" class="site-nav">CMS Page</a></li>
                                            <li><a href="<?php echo site_url('pages/elements_icons'); ?>" class="site-nav">Icons</a></li>
                                            <li><a href="<?php echo site_url('pages/error_404'); ?>" class="site-nav">Error 404</a></li>
                                            <li><a href="<?php echo site_url('pages/coming_soon'); ?>" class="site-nav">Coming soon <span class="lbl nm_label2">New</span></a></li>
                                        </ul>
                                    </li>
                                    <li class="lvl1 parent dropdown"><a href="#">Blog <i class="icon anm anm-angle-down-l"></i></a>
                                        <ul class="dropdown">
                                            <li><a href="<?php echo site_url('blog/blog_grid'); ?>" class="site-nav">Grid View</a></li>
                                            <li><a href="<?php echo site_url('blog/blog_list'); ?>" class="site-nav">List View</a></li>
                                            <li><a href="<?php echo site_url('blog/blog_grid_sidebar'); ?>" class="site-nav">Left Sidebar</a></li>
                                            <li><a href="<?php echo site_url('blog/blog_list_sidebar'); ?>" class="site-nav">Right Sidebar</a></li>
                                            <li><a href="<?php echo site_url('blog/blog_masonry'); ?>" class="site-nav">Masonry Grid</a></li>
                                            <li><a href="<?php echo site_url('blog/blog_details'); ?>" class="site-nav">Blog Details</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
...
<!-- Mirrored from www.annimexweb.com/items/hema/cart-style1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:43:49 GMT -->
</html>