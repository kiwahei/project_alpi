...
<!-- Mirrored from www.annimexweb.com/items/hema/index4-electronic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:34:21 GMT -->
...
<head>
    ...
    <!-- Title Of Site -->
    <title>Project PWE - Alfiansyah Aresta</title>
    <base href="">
    <!-- Favicon -->
            ...
            <header class="header classicHeader d-flex align-items-center header-4 header-fixed">
                <div class="container-fluid">
                    <div class="row">
                        <!-- Menu -->
                        <div
                            class="col-1 col-sm-1 col-md-1 col-lg-5 align-self-center d-menu-col hdr-menu-left menu-position-left">
                        ...
                        <div class="logo col-4 col-sm-4 col-md-4 col-lg-2 align-self-center">
                            <a class="logoImg" href="<?php echo site_url('home'); ?>">
                                <img class="mx-lg-auto default-logo" src="assets/images/logo-white.png"
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a href="product-layout1.html" class="product-img">
                                                ...
                                                <img class="hover blur-up lazyload"
                                                    data-src="assets/images/products/electronic-product1-1.jpg"
                                                    src="assets/images/products/electronic-product1-1.jpg" alt="Product"
                                                    title="Product" width="625" height="625" />
                                                <!-- End Hover Image -->
                                            </a>
                                            <!-- End Product Image -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a href="product-layout1.html" class="product-img">
                                                <!-- Image -->
                                                <img class="primary blur-up lazyload"
                                                    data-src="assets/images/products/electronic-product2.jpg"
                                                    src="assets/images/products/electronic-product2.jpg" alt="Product"
                                                    title="Product" width="625" height="625" />
                                                <!-- End Image -->
                                                <!-- Hover Image -->
                                                <img class="hover blur-up lazyload"
                                                    data-src="assets/images/products/electronic-product2-1.jpg"
                                                    src="assets/images/products/electronic-product2-1.jpg" alt="Product"
                                                    title="Product" width="625" height="625" />
                                                <!-- End Hover Image -->
                                            </a>
                                            <!-- End Product Image -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-contact">
                            ...
                            <p class="address d-flex"><i class="icon anm anm-map-marker-al pt-1"></i> Jl. Ungaran Ujung
                                No.14, Kel. Pasar Manggis, Kec. Setia Budi, Jakarta Selatan 12970</p>
                            <p class="phone d-flex align-items-center"><i class="icon anm anm-phone-l"></i> <b
                                    class="me-1 d-none">Phone:</b> <a href="tel:401234567890">(+62) 857 7933 7943</a>
                            </p>
                            <p class="email d-flex align-items-center"><i class="icon anm anm-envelope-l"></i> <b
                                    class="me-1 d-none">Email:</b> <a
                                    href="mailto:info@example.com">alfiansyaharesta1412@gmail.com</a></p>
                            <p class="work-hour d-flex mb-0"><i class="icon anm anm-clock-r pt-1"></i><span
                                    class="hour-time">Working Hours: <br />Monday - Friday | 9:00 AM - 10:00 PM</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="m-0 clearfix">
                        <li class="item d-flex justify-content-center align-items-center">
                            <a class="product-image" href="product-layout1.html">
                                <img class="blur-up lazyload"
                                    data-src="assets/images/products/cart-electronic-product-img1.jpg"
                                    src="assets/images/products/cart-electronic-product-img1.jpg" alt="product"
                        ...
                        <li class="item d-flex justify-content-center align-items-center">
                            <a class="product-image" href="product-layout1.html">
                                <img class="blur-up lazyload"
                                    data-src="assets/images/products/cart-electronic-product-img2.jpg"
                                    src="assets/images/products/cart-electronic-product-img2.jpg" alt="product"
                                    title="Product" width="120" height="170" />
                            </a>
                            <div class="product-details">
                                    ...
                                    <div class="product-options d-flex-wrap">
                                        <div class="product-item swatches-image w-100 mb-3 swatch-0 option1"
                                            ...
                                            <ul class="variants-clr swatches d-flex-center pt-1 clearfix">
                                                <li class="swatch large radius available active"><img
                                                        src="assets/images/products/swatches/blue-red.jpg" alt="image"
...
<!-- Mirrored from www.annimexweb.com/items/hema/index4-electronic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Sep 2024 03:35:15 GMT -->
